...
<Content style="margin-top:2.5rem;padding: 0;margin-left: 0;">
  ...
  {:else}
    <div style="margin-top:20vh; text-align: center;">
      <h1 style="font-size: 7rem;">Packet Play 📤</h1>
...
<div id="footer">
  Simulate <span> &nbsp; &bullet; &nbsp;</span> Analyze <span> &nbsp; &bullet; &nbsp;</span> Innovate
  <!-- Developed by <span> &nbsp; &bullet; &nbsp;</span> -->
  <!-- <a href="https://github.com/metakunal" class="footer-text">Kunal Yadav</a> -->
