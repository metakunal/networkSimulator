...
<div id="mySidenav" class="sidenav">
  ...
  <div
    class="items"
    onclick="window.open('https://github.com/metakunal/networkSimulator/tree/main','mywindow');"
  >
    <LogoGithub32 />
    <a href="https://github.com/metakunal/networkSimulator/tree/main">Github</a>
  </div>
</div>
