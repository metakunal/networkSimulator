...
function Demo2() {
  ...
  //Create a hub 1 with 4 ports
  var hub1 = new Hub("Hub1", 4);
  //Create a switch 1 with 4 ports
  ...
  pc1.transmitLayer2(pc2.macAddress, "PC1 Payload");
  pc3.transmitLayer2(pc1.macAddress, "PC2 Payload");
  pc1.transmitLayer2(pc3.macAddress, "PC3 Payload");
}
